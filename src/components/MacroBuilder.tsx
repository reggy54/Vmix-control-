...
export function MacroBuilder({ macros, setMacros, playMacro }: Props) {
                  ...
                  {activeMacro.steps.map((step, index) => (
                     <div key={index} className="flex flex-col sm:flex-row gap-2 bg-[#161616] border border-[#333] p-2 rounded items-center">
                        ...
                        <input 
                           ...
                           className="bg-[#111] border border-[#333] px-2 py-1.5 rounded text-xs text-gray-300 outline-none w-full sm:w-28 placeholder-gray-600"
                        />

                        <div className="flex items-center space-x-1 sm:ml-auto bg-[#1a1a1a] rounded px-2 py-1 border border-[#333]">
                           ...
                           <input 
                              ...
                              className="bg-transparent w-16 text-right text-orange-400 font-mono text-xs outline-none"
                           />
